...
kubectl apply -n tech-challenge -f ./contacts-query/k8s/pvs/db-pv.yml 
...
kubectl apply -n tech-challenge -f ./contacts-query/k8s/pvcs/db-pvc.yml 
...
kubectl apply -n tech-challenge -f ./contacts-query/k8s/services/db-service.yml 
kubectl apply -n tech-challenge -f ./contacts-query/k8s/services/api-service.yml 
...
kubectl apply -n tech-challenge -f ./contacts-query/k8s/deployments/db-deployment.yml 
kubectl apply -n tech-challenge -f ./contacts-query/k8s/deployments/api-deployment.yml 
