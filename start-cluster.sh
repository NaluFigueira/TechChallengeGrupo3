...
kubectl apply -n tech-challenge -f ./k8s/configmaps/grafana-configmap.yml 

# Apply Persistent Volume Claims
kubectl apply -n tech-challenge -f ./users/k8s/pvcs/db-volume.yml 
kubectl apply -n tech-challenge -f ./k8s/pvcs/monitoring-volume.yml 
...
kubectl apply -n tech-challenge -f ./k8s/services/grafana-service.yml 
...
kubectl apply -n tech-challenge -f ./k8s/deployments/monitoring-deployment.yml 
