...
kubectl delete services tech-challenge-grafana-service -n tech-challenge
...
kubectl delete deployment tech-challenge-monitoring-deployment -n tech-challenge
...
kubectl delete pvc tech-challenge-monitoring-pvc -n tech-challenge
